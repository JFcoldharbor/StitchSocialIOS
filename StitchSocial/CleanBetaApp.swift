...
struct StitchSocialApp: App {
    ...
    // NEW: Shared NotificationService for entire app
    @StateObject private var notificationService = NotificationService()
    
    var body: some Scene {
        WindowGroup {
            ContentView()
                .environmentObject(notificationService) // NEW: Pass to environment
                .overlay(
                    // NEW: Toast notification overlay above all content
